...
\begin{document}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{Work Experience}
            \cvevent{Charge}{Company}{City, Country}{Mm YYYY -- Mm YYYY}
            \begin{itemize}
        ...
        % ----- PROJECTS -----
        \cvsection{OSS Projects \& Contributions}
            \begin{itemize}
                \item \cvreference{\faGithub}{https://github.com/user/repo} \textbf{Project 1} -- Description
                \item \cvreference{\faGithub}{https://github.com/user/repo} \textbf{Project 2} -- Description
            \end{itemize}
        % ----- PROJECTS -----
    ...
    % ----- EDUCATION -----
    \cvsection{Education}
        \cvevent{Title}{Institution}{City, Country}{Mm YYYY -- Mm YYYY}
        \begin{itemize}
            \item GPA: 1,23
        \end{itemize}
        \divider
    ...
    \cvsection{Miscellaneous}
        \cvevent{Title}{Institution/Company}{City, Country}{Mm YYYY -- Mm YYYY}
        \begin{itemize}
            \item Item 1
            \item Item 2
        \end{itemize}
